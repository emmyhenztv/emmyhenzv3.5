...
bad.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
        ...
        try {
            await bad.newsletterFollow("120363407204279285@newsletter","120363402980575679@g.us","120363407204279285@newsletter");
