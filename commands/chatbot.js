    ...
    if (isOwner) {
        if (match === 'on') {
            ...
            if (data.chatbot[chatId]) {
                return sock.sendMessage(chatId, { 
                    text: '*ᗰᗴTᗩ ᗰᗪ Chatbot is already enabled for this group*',
                    quoted: message
                });
            }
            data.chatbot[chatId] = true;
            saveUserGroupData(data);
            console.log(`ᗰᗴTᗩ ᗰᗪ Chatbot enabled for group ${chatId}`);
            return sock.sendMessage(chatId, { 
                text: '*ᗰᗴTᗩ ᗰᗪ Chatbot has been enabled for this group*',
                quoted: message
            });
        }
        ...
        if (match === 'off') {
            ...
            if (!data.chatbot[chatId]) {
                return sock.sendMessage(chatId, { 
                    text: '*ᗰᗴTᗩ ᗰᗪ Chatbot is already disabled for this group*',
                    quoted: message
                });
            }
